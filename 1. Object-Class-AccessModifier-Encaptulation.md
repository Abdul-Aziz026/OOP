...
### what is class?
class is a template/blueprint from which individual object can be created.
...
<ins>**constructor**</ins>
- in C++ constructor method automatically called when an object of a class is created.   
...
- It's called automatically when an object is going to be destroyed.
...
```
![image](https://github.com/Abdul-Aziz026/OOP/assets/57495952/0f56def7-21b1-4177-8560-f1101bebf2f7)
